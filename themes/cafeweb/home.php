    ...
    <div class="home_features">
        <section class="container content">
            <header class="home_features_header">
                <h2>O que você pode fazer com o AppControl?</h2>
    ...
    <article class="home_optin">
        <div class="home_optin_content container content">
            <header class="home_optin_content_flex">
                <h2>Cadastre-se no AppControl e comece a controlar suas contas hoje mesmo</h2>
                <p>Receber e pagar é uma tarefa comum do dia a dia, o AppControl é um gerenciador de contas simples,
                    fácil
